...
Rays approximate the path of light, as it propagates from a point on the object, towards the optic. The simulation's ray tracer provides three representation for rays: Marginal, Principal, and Many.
