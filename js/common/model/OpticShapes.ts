...
class OpticShapes {
   ...
   * @param {Object} [options]
   */
  private setLensShapes( opticShape: OpticShapeEnum, radiusOfCurvature: number, diameter: number,
                         options?: any ): void { //TYPESCRIPT any
   ...
   * @param {Object} [options]
   */
  private setMirrorShapes( opticShape: OpticShapeEnum, radiusOfCurvature: number, diameter: number,
                           options?: any ): void { //TYPESCRIPT any
