...
<a href="https://phet.colorado.edu/sims/html/geometric-optics/latest/geometric-optics_en.html" target="_blank">Click
here to run "Geometric Optics".</a>
...
(5) Open in the browser: `http://localhost/geometric-optics/geometric-optics_en.html` (You will probably need to modify
...
(3) Open in the
browser: `http://localhost/geometric-optics/build/adapted-from-phet/geometric-optics_en_adapted-from-phet.html` (You
